...
def find_l2_space():
    ...
    space[11] = {
        ...
        'max_bin': hp.choice('max_bin', [128, 256]),
        'colsample_bytree': hp.choice('colsample_bytree', [0.6, 0.7, 0.8]),  # remove 0.7
        'colsample_bylevel': 1,
    ...
    space[20] = {
        ...
        'colsample_bylevel': 1,
        'subsample': hp.choice('subsample', [0.6, 0.7, 0.8]),
        'gamma': 500,
        'lambda': hp.choice('lambda', [0, 1, 2]),  # remove 10
        'eta': 0.05,
    }

    space[30] = {
        'booster': 'gbtree',
        'max_depth': hp.choice('max_depth', [12, 15]),
        'max_bin': hp.choice('max_bin', [16, 32]),
        'colsample_bytree': hp.choice('colsample_bytree', [0.6, 0.7, 0.8]),  # remove 0.7
        'colsample_bylevel': 1,
        'subsample': hp.choice('subsample', [0.6, 0.7, 0.8]),
    ...
    space[35] = {
        ...
        'colsample_bytree': 0.3,  # remove 0.7
        'colsample_bylevel': 1,
        'subsample': hp.choice('subsample', [0.8, 0.9, 1]),
        'gamma': hp.choice('gamma', [250, 500]),
        'lambda': hp.choice('lambda', [1, 0]),  # remove 10
        'eta': 0.05,
    }
    ...
    space[40] = {
        'booster': 'dart',
        'max_depth': hp.choice('max_depth', [8, 10]),
        'max_bin': hp.choice('max_bin', [1024, 512]),
        'colsample_bytree': hp.choice('colsample_bytree', [0.5, 0.6, 0.7]),  # remove 0.7
        'colsample_bylevel': 1,
    ...
    space[51] = {
        'booster': 'gbtree',
        'max_depth': hp.choice('max_depth', [9, 10, 11]),
        'max_bin': hp.choice('max_bin', [128, 256]),
        'colsample_bytree': hp.choice('colsample_bytree', [0.8, 0.9, 1]),  # remove 0.7
        'colsample_bylevel': 1,
        'subsample': hp.choice('subsample', [0.7, 0.8]),
        'gamma': 100,
        'lambda': hp.choice('lambda', [0, 1]),  # remove 10
    ...
    space[65] = {
        ...
        'colsample_bytree': hp.choice('colsample_bytree', [0.6, 0.7, 0.8]),  # remove 0.7
        'colsample_bylevel': 1,
        'subsample': hp.choice('subsample', [0.3, 0.4, 0.5]),
        'gamma': 100,
        'lambda': hp.choice('lambda', [5, 15]),  # remove 10
        'eta': 0.05,
    }
