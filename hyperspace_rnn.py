...
space_all = {
    ...
    'kernel_size': hp.choice('kernel_size',[64, 256]), #CNN kernel size - num of different "scenario"
    'num_gru_layer': 3,     # number of layers # drop 1, 2
    'gru_nodes_mult': hp.choice('gru_nodes_mult', [0, 1]),      # nodes growth rate *1 or *2
    'gru_nodes': hp.choice('gru_nodes', [8, 16]),    # start with possible 4 nodes -- 8, 8, 16 combination possible
    'gru_dropout': hp.choice('gru_drop', [0.25, 0.5]),

    'activation': 'tanh',
    'batch_size': hp.choice('batch_size', [128, 64]), # drop 1024
}
